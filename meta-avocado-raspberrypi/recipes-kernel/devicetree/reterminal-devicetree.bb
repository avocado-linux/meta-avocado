...
SRC_URI = "\
    ...
    https://raw.githubusercontent.com/Seeed-Studio/seeed-linux-dtoverlays/${SRCREV}/overlays/rpi/reTerminal-bridge-overlay.dts;downloadfilename=reTerminal-bridge.dts;name=reTerminal-bridge \
...
do_install() {
    ...
    install -m 0644 ${B}/reTerminal-bridge.dtbo ${D}${nonarch_base_libdir}/firmware/overlays/
