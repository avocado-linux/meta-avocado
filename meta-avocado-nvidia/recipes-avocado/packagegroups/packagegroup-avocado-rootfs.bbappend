...
# alt mc (jetson-l4t, linux-jammy-nvidia-tegra 5.15) and has unversioned
...
# packagegroup therefore drags the entire 5.15 kernel chain into the
# resolution regardless of which kernel the rootfs is targeting, even
# when the lockfile pins linux-yocto 6.6.
#
...
# selected. Pinning a kernel without OOT (linux-yocto 6.6) skips the
