# The config fragments live in the in-tree linux files dir (shared with the
# linux-imx bbappend); this bbappend sits under dynamic-layers/ so point at it
# via the layer.conf var rather than ${THISDIR}/files.
