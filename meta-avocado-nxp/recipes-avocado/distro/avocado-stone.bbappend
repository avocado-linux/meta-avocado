...
do_stone_provision:append() {
  ...
  export AVOCADO_PARTITION_BOOT_A_OFFSET="${boot_a_offset_blocks}"
  export AVOCADO_PARTITION_BOOT_A_BLOCKS="${boot_a_size_blocks}"
  export AVOCADO_PARTITION_BOOT_B_OFFSET="${boot_b_offset_blocks}"
  export AVOCADO_PARTITION_BOOT_B_BLOCKS="${boot_b_size_blocks}"
  ...
  bbnote "AVOCADO_PARTITION_BOOT_A_OFFSET=${AVOCADO_PARTITION_BOOT_A_OFFSET}"
  bbnote "AVOCADO_PARTITION_BOOT_A_BLOCKS=${AVOCADO_PARTITION_BOOT_A_BLOCKS}"
  bbnote "AVOCADO_PARTITION_BOOT_B_OFFSET=${AVOCADO_PARTITION_BOOT_B_OFFSET}"
  bbnote "AVOCADO_PARTITION_BOOT_B_BLOCKS=${AVOCADO_PARTITION_BOOT_B_BLOCKS}"
