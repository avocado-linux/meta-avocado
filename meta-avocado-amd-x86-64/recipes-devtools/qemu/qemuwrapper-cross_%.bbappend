# Native-exec qemuwrapper for avocado-amd-x86-64-v4.
#
# v4 opts qemu-usermode out (avocado-amd-x86-64-v4.conf) because QEMU's TCG
...
#
# Mirrors meta-avocado-x86-64's Intel-scoped qemuwrapper-cross_%.bbappend (PR
# #395) for the AMD-scoped machine. BitBake merges bbappends by layer+path, not
# by filename alone, so this coexists cleanly with that one.

FILESEXTRAPATHS:prepend := "${THISDIR}/files:"

SRC_URI:append:avocado-amd-x86-64-v4 = " file://qemuwrapper-native"
...
LIC_FILES_CHKSUM:avocado-amd-x86-64-v4 = "file://${COMMON_LICENSE_DIR}/MIT;md5=0835ade698e0bcf8506ecda2f7b4f302"
...
AVOCADO_NATIVE_EXEC_REQUIRES_FLAGS:avocado-amd-x86-64-v4 = "avx512f avx512bw avx512cd avx512dq avx512vl"
...
do_install:append:avocado-amd-x86-64-v4() {
